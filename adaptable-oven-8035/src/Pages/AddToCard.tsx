    ...
    <>
      ...
      <Div>
                    ...
                    >
                      <Box width="300px" p="10px">
                        <Image
                          ...
                          objectFit="cover"
                          mr={4}
                          boxShadow="0px 9px 30px 0px rgba(0,0,0,1);"
                        />
                      </Box>

                      <Box mt={4} width="200px" p="10px" bg="white" textAlign="center">
                        <Heading as="h1" mt="10px" size="lg">
                          {el.about}
                        </Heading>
        ...
        <div className="checkout">
          ...
          <div id="IK">
            <div>ESTIMATED SHIPPING CHARGES</div>
            <div>₹ 0.00</div>
          </div>
          <div id="IK">
            <div>TAX</div>
